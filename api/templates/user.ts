...
<body>
  <div class="mainContainer"
    ...
    <div class="headerContainer"
      style="background-color: rgb(33, 37, 41);height: 56px;padding: 8px 16px;display: flex;box-shadow: 0px 5px rgb(33, 37, 41, 0.05);">
    ...
    <div class="bodyContainer" style="color:black;padding: 16px;flex-grow: 1;background-color: rgba(0, 0, 0, 0.05);">
    ...
    <div class="footerContainer"
      style="background-color: rgb(33, 37, 41);min-height: 56px;padding: 8px 16px;display: flex;align-items: center;justify-content: flex-end;">
      <div class="footerLeftContainer" style="display: flex;margin:auto;">
        <span class="footerText2" style="color: white;font-size: 14px;">
          All right reserved ${senderName} @ 2020
        </span>
      </div>
    </div>
  </div>
