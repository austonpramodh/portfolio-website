...
import { Avatar, Box, Container, Link, List, ListItem, Typography } from "@mui/material";
        ...
        <SliceContainer id={slice.primary.section_id || slice.id}>
            ...
            >
                ...
                >
                    ...
                    <Typography color="textPrimary" variant="h2" fontWeight="bold" sx={() => ({})}>
                        {slice.primary.name}
                    </Typography>
                    ...
                    {staticData.externalLinksData && (
                        <ContactLinks
                            linksData={staticData.externalLinksData.external_link.map((link) => ({
